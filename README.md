...
> **[v1.11.1-dev.5](https://github.com/AngelDark92/steamlink-patches/releases/tag/v1.11.1-dev.5)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;23 patches total
<details open>
...
| [Galaxy XR legacy foundation (through 2.0.22/5002244)](#galaxy-xr-legacy-foundation-through-2-0-22-5002244) | Applies the Galaxy XR conversion foundation to the exact supported Steam Link builds through 2.0.22 build 5002244. Diagnostic force gates and controller tuning remain optional. | 5001712, 5001740, 5002172, 5002206, 5002244 |  |
