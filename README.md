...
- **UDP receive buffer (experimental)** is a separate, default-off patch for exact 2.0.22/5002322 and 2.0.23/5002363. It requests 8 MiB instead of 1 MiB for the VR receive socket; no bundle includes it. [Experiment and validation](diagnostics/steamlink-hitches/EXPERIMENT-2026-09-15-udp-receive-buffer.md).
