...
| [Appear on top (legacy)](#appear-on-top-legacy) | Legacy overlay-permission fallback retained for older Steam Link builds. Adds SYSTEM_ALERT_WINDOW and the compositor signal window. Disabled by default. | 5001712, 5001740, 5002172, 5002206, 5002244, 5002313, 5002318 |  |
