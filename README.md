...
> **[v1.10.1-dev.18](https://github.com/AngelDark92/steamlink-patches/releases/tag/v1.10.1-dev.18)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;23 patches total
<details open>
...
| [Appear on top](#appear-on-top) | Adds SYSTEM_ALERT_WINDOW and the compositor signal window; build 5002322 also gets passive pass-through telemetry and shell-protected surface controls. | 5001712, 5001740, 5002172, 5002206, 5002244, 5002313, 5002318, 5002322 |  |
