...
> **[v1.11.0-dev.3](https://github.com/AngelDark92/steamlink-patches/releases/tag/v1.11.0-dev.3)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;21 patches total
<details open>
...
| [Appear on top](#appear-on-top) | Adds SYSTEM_ALERT_WINDOW and the compositor signal window. | 5001712, 5001740, 5002172, 5002206, 5002244, 5002313, 5002318, 5002322 |  |
