...
> **[v1.14.2-dev.1](https://github.com/AngelDark92/steamlink-patches/releases/tag/v1.14.2-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;24 patches total
<details open>
...
| [Galaxy XR recommended set (2.0.20/5001712)](#galaxy-xr-recommended-set-2-0-20-5001712) | Applies the 17-patch Galaxy XR legacy set for exact Steam Link 2.0.20 build 5001712, including Meta Quest Pro identity, permission-free high resolution, and the Final balanced tested OLED profile. | 5001712 |  |
| [Galaxy XR recommended set (2.0.22/5002318)](#galaxy-xr-recommended-set-2-0-22-5002318) | Applies the 9-patch Galaxy XR set for exact Steam Link 2.0.22 build 5002318, including separate startup permission requests and splash/XR launch-mode patches. | 5002318 |  |
| [Galaxy XR recommended set (2.0.22/5002322)](#galaxy-xr-recommended-set-2-0-22-5002322) | Applies the 6-patch Galaxy XR set for exact Steam Link 2.0.22 build 5002322, including the Final balanced tested OLED profile; preserves stock startup except for battery settings. Revised startup flow awaits headset validation. | 5002322 |  |
...
| [Startup splash and XR launch mode (before 5002322)](PATCH_CATALOG.md#startup-splash-and-xr-launch-mode-before-5002322-xrlauncherbootstrappatch) | Adds the Launching Steam Link splash, older-build panel sizing and explicit unmanaged VRLink startup. Runtime permission requests are separately selected. | 5001712, 5001740, 5002244, 5002296, 5002313, 5002318 |  |
| [Startup permission requests (before 5002322)](PATCH_CATALOG.md#startup-permission-requests-before-5002322-xrstartuppermissionspatch) | Declares and requests hand, eye and face tracking, microphone and Bluetooth permissions before opening Steam Link on exact older builds. Battery settings and visible splash are separate patches. | 5001712, 5001740, 5002244, 5002296, 5002313, 5002318 |  |
