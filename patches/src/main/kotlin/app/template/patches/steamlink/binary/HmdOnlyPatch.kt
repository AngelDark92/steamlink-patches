...
private val PATCHED_HOOK = byteArrayOf(0xf6.toByte(), 0x5e, 0x04, 0x14)

private val ORIG_CAVE = byteArrayOf(
    0x90.toByte(), 0x00, 0x00, 0xd0.toByte(), 0x11, 0xb6.toByte(), 0x44, 0xf9.toByte(),
    0x10, 0xa2.toByte(), 0x25, 0x91.toByte(), 0x20, 0x02, 0x1f, 0xd6.toByte(),
    0x90.toByte(), 0x00, 0x00, 0xd0.toByte(), 0x11, 0xba.toByte(), 0x44, 0xf9.toByte(),
    0x10, 0xc2.toByte(), 0x25, 0x91.toByte(), 0x20, 0x02, 0x1f, 0xd6.toByte(),
)
private val PATCHED_CAVE = byteArrayOf(
    ...
    0x07.toByte(), 0xa1.toByte(), 0xfb.toByte(), 0x17, 0x1f, 0x20, 0x03, 0xd5.toByte(),
